...
<head>
  ...
  <link rel="stylesheet" href="Accueil_Enseignant.css">
</head>
<body>
  ...
  <main class="flex-fill d-flex align-items-center justify-content-center">
    <div class="dashboard">
      <h2>Bonjour (Nom de l’Enseignant)</h2>
      <p>Que souhaitez-vous faire ?</p>

      <div class="action-buttons">
        <a href="Réserver_SalleE.php" class="btn btn-action">Réserver une Salle</a>
        <a href="Réservations_Effectuées.php" class="btn btn-action">Voir les Réservations</a>
      </div>
    </div>
  </main>
